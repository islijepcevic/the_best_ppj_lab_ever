...
class SemantickiAnalizator:
    ...
    def definicija_funkcije( self, cvor, djelokrug ):
        ...
        if type( cvor.djeca[3] ) == NezavrsniZnak:
            ...
            svojstva_parametri = {}
            povratak = self.lista_parametara( cvor.djeca[3], djelokrug,
                                            svojstva_parametri )
        ...
        if svojstva_parametri['tipovi'].je_li_void():
    ...
    def lista_parametara( self, cvor, djelokrug, izvedena_svojstva = {} ):
        pass
